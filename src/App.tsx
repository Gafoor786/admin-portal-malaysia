  ...
  const StyledOuterBox = styled(Box)(({ theme }) => {
    return ({
      ...
      [theme.breakpoints.up('md')]: {
        ...
        minHeight: `calc(100vh - ${theme.spacing(state.authenticated ? 2 : 1)})`,
    ...
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <StyledBox component="main" sx={{
          ...
          <Grid >
            <Grid sx={{
              padding: (theme) => state.authenticated ? theme.spacing(1, 1, 1, 0) : theme.spacing(0),
            }}>
              <StyledOuterBox
