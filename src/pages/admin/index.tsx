...
const Admin = (props: ReactPropTypes) => {
    ...
    return (
        <div>
            ...
            <Switch>
                <AsyncRoute path={RouterLinks.admin.ADD} importPath={import('./add-admin')} />
                <AsyncRoute path={RouterLinks.admin.LIST} importPath={import('./list-admin')} />
                <Route exact path={RouterLinks.admin.INDEX}>
                    <Redirect to={RouterLinks.admin.ADD} />
                </Route>
            </Switch>
        </div>
    );
